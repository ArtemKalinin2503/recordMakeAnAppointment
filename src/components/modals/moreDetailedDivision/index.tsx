...
import {
  ...
  StyledValueItem,
  StyledWrapperMain,
} from "./moreDetailedDivision.styled";

const MoreDetailedDivision = ({ title, listItems, handleDelete, handleChange }: MoreDetailedProps) => {
...
export default MoreDetailedDivision;
